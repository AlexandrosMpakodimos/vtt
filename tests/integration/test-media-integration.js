...
//   Manual-only, not registered. Use the existing isolated test server:
//     node scripts/test-local.js test-media-integration.js
//   Historical conditional/byte-serving checks remain unchanged.
//
