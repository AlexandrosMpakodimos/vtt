...
async function scenario(mode){
 ...
 vm.runInNewContext(fs.readFileSync(rootPath('src/config/passport.js'),'utf8'),{module:{exports:{}},require(name){
 ...
 const source=fs.readFileSync(rootPath('src/routes/auth.js'),'utf8');
