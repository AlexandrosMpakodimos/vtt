...
(async () => {
  ...
  await test('production config rejects bad captured values without printing them', async () => {
    const env={COORDINATION_URL:'redis://127.0.0.1:6379',BASE_URL:'https://fixture.invalid',NODE_ENV:'production',DATABASE_URL:'postgresql://fixture:fixture@ep-fixture-pooler.us.aws.neon.tech/fixture',SESSION_SECRET:'fixture-only-not-a-real-secret-123456'};
