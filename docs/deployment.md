...
| Unregistered media suite | Review `test-media-integration.js` prerequisites and decide its status without silently changing the recorded 69-suite baseline |
